      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-8 px-4 lg:grid-cols-2 lg:gap-12">
        <motion.div style={{ y: prefersReduced ? 0 : y, opacity: prefersReduced ? 1 : opacity }} className="relative order-2 lg:order-1">
          ...
          >
            ...
            <a
              href={`tel:${PHONE}`}
              className="inline-flex items-center gap-2 rounded-full border-2 border-foreground/20 bg-transparent px-5 py-3 text-sm font-semibold text-foreground shadow-soft transition-transform hover:scale-105 hover:bg-foreground/10 md:px-6 md:py-3.5"
            >
              <Phone className="h-4 w-4" />
              Call Now
            </a>
